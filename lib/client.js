...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function TurnRail({ useProjection, sessionId, sessionsService, t }) {
      ...
      // Scrolling rail, bottom-pinning only:
      // - on open, or while the current turn is among the latest turns, show
      //   the newest window;
      // - otherwise leave the rail where the user scrolled it. No mid-rail
      //   auto-follow, because it fights click-to-jump and feels busy.
      React.useEffect(() => {
